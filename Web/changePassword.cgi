	...
	<div class="page">
		...
		<div class="content">
			<div class="content-block" style="overflow: hidden">
				...
				<p><small><b>警告：</b>你将要修改密码，请仔细核对输入信息，修改后的密码请务必妥善保存。如果你忘记修改后的密码，我们将无能为力，届时只能求助学校教务部门。我们不承担任何风险责任。密码限制长度为10位，修改成功后，需要重新登录。</small></p>
							...
							<div class="item-content">
								...
								<div class="item-inner">
									...
									<div class="item-input">
										<input name="mm" type="password" placeholder="最长10位" id="i_xhs">
									</div>
