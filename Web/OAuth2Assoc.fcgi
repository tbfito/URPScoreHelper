...
<div class="content">
	<form action="/OAuth2Assoc.fcgi?openid=%s&proc=%s" method="post" class="weui-cells weui-cells_form">
		...
		<div class="weui-btn-area">
			<button id="i_submit" type="submit" class="weui-btn weui-btn_primary"><i class="fa fa-link"></i>绑定</button>
		</div>
	</form>
	<br />
</div>