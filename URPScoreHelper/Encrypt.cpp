...
void EnCodeStr(char *str, char *out)
{
	...
	AES_ECB_encrypt((const uint8_t *)str, (const uint8_t *)APP_NAME, encrypted, strlen(str));
...
void DeCodeStr(char *pCode)
{
	...
	AES_ECB_decrypt((const uint8_t *)strCode, (const uint8_t *)APP_NAME, decrypted, 4096);
