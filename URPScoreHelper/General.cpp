...
char GLOBAL_HEADER[1024] = {0};
char GLOBAL_HEADER_TYPE_PLAIN_TEXT[1024] = { 0 };
...
const char *OAUTH2_LOGIN_HTML = u8"<a id=\"no_ajax\" class=\"weui-btn weui-btn_primary oauth col-50\" href=\"OAuth2.fcgi\"><i class=\"fa fa-weixin\"></i>微信登录</a>";
const char *QUICKQUERY_HTML = u8"<a class=\"weui-btn quickquery\" href=\"QuickQuery.fcgi\"><i class=\"fa fa-search\"></i>学号快查</a>";
